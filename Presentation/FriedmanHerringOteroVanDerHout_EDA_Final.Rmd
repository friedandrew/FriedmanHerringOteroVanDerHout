...
*replace data scraping below with spatial versions of AIM, dam, flow, and catchment data (this means figuring out writing and reading in sf data vs csv...)
...
#Data Scraping
```{r AIM & Dam data scraping and saving as csv files, eval=FALSE, include=FALSE}
# Import AIM Data
