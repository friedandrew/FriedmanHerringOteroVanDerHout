...
upstream_dams_plot <- ggplot(data=upstream_dams, aes(x=OBJECTID, y=Number_of_dams_upstream)) +
  geom_bar(stat="identity") + labs(x = "AIM Site", y = "Total Number of Dams Upstream")
