...
#write.csv(dam_complete_raw, "./New Data/dam_complete_raw")
```
...
Dam_WAAIM_Join_function <- function(WAAIM_ROW_NUM, WAAIM_DATA, DAM_DATA){
  ...
  site_dams_summary <- as.data.frame(summary(as.factor(site_dams$Fish.Passage.Catagory)))
