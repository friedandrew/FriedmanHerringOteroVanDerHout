...
WAAIM_tidy <- WAAIM %>% 
  select(OBJECTID, SITE_CD, STRM_NM, MIDLAT, MIDLONG, STRM_ORDR, BTMLAT, BTMLONG, TRLAT, TRLONG, TOT_RCH_LEN, PCT_OVRHD_CVR, VEG_CMPLXTY, RPRN_VEG_CNPY_CVR, RPRN_VEG_UNDRSTRY_CVR, RPRN_VEG_GC, NON_NTVE_WDY, NTVE_WDY, NON_NTVE_HRB, NTVE_HRB, SDGE_RSH, OBSRVD_INVRT_RCHNSS, EXPCTD_INVRT_RCHNSS, MACROINVRTBRTE_CNT, TTL_N, PRD_TTL_N, TTL_P, PRD_TTL_P, SPCFC_CNDCTNCE, PRD_SPCFC_CNDCTNCE, pH, INSTNT_TEMP, PCT_PL, RES_PL_DEP, NM_PL, LWD_FREQ, LWD_VL, PCT_FN2, PCT_FN6, D16, D84, D50, BNK_STBLTY, BNK_CVR_LWD, BNKFLL_HT, INCSN_HT, CHN_INCSN, THLWG_DEP_MN, PCT_DRY, BNKFLL_WT, WTTD_WT, FLD_WT, ENTRCH, SLPE, SNSTY, BVR_SGN, geometry)
rm(WAAIM)
#NM_PL = number of pools
